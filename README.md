...
Repository contains sample codes required to build a private chat application using Cloudilly iOS ObjC SDK. Offline messaging implemented _store_ and _remove_
